    ...
    def select_run(self):
        ...
        if select_num == 1:
            ...
            try:
                ...
                print("script has something wrong, backing to menu...")
            self.select_run()
        elif select_num == 2:
            print("-----setup BOX-----")
            time.sleep(1)
...
class Setup_Center(object):
    ...
    def center_net_set(self):
        #driver.find_element(By.CSS_SELECTOR, "fieldset:nth-child(1) .el-switch__core").click()#地址映射开
        #driver.find_element(By.CSS_SELECTOR, ".is-checked > .el-switch__core").click()#地址映射关
        driver.find_element(By.CSS_SELECTOR, "fieldset:nth-child(2) .el-switch__core").click()#有内网网关
        #tab,enter,tab,tab
        #driver.find_element(By.CSS_SELECTOR, ".is-checked > .el-switch__core").click()#无内网网关（默认）
        driver.find_element(By.CSS_SELECTOR, "fieldset:nth-child(1) > .el-form-item:nth-child(3) .el-input__inner").send_keys("192.168.3.200/24")
        driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(4) .el-input__inner").send_keys("192.168.3.1")
        driver.find_element(By.CSS_SELECTOR, "fieldset:nth-child(2) > .is-success .el-input__inner").send_keys("192.168.100.234/24")
        driver.find_element(By.CSS_SELECTOR, "fieldset:nth-child(2) > .el-form-item:nth-child(4) .el-input__inner").send_keys("192.168.100.101")
        ...
        try:
            ...
            time.sleep(5)
            driver.find_element(By.CSS_SELECTOR, ".el-dialog__wrapper:nth-child(3) .el-dialog__close").click()
        except:
...
class Setup_BOX(object):
    ...
    def BOX_set(self):
        element_BOX_init_Login = WebDriverWait(driver, 5).until(EC.presence_of_element_located((By.CSS_SELECTOR, ".el-form-item:nth-child(3) .el-input__inner")))
    ...
    def BOX_set_run(self):
        pyautogui.alert('BOX启动并连接有线后点击「确定」')
        self.web_open_BOX()
        self.BOX_set()
        driver.minimize_window()
...
class Setup_Node(object):
    ...
    def Node_Resource_set(self, outer_net, inner_net, innner_gateway):
        ...
        time.sleep(0.2)
        #driver.find_element(By.CSS_SELECTOR, ".is-success .el-input__inner").send_keys(outer_net)
        #driver.find_element(By.CSS_SELECTOR, ".is-success:nth-child(2) .el-input__inner").send_keys("192.168.3.1")
        #driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(3) .el-input__inner").send_keys("192.168.3.200:32749")
...
class Reset_devices(object):
    ...
    def BOX_reset(self):
        ...
        '''
        try:
            WebDriverWait(driver, 2).until(EC.presence_of_element_located((By.CSS_SELECTOR, ".el-dropdown:nth-child(1) .set"))).click()
            time.sleep(0.2)
            pyautogui.press('down', 3)
            pyautogui.press('enter')
            ...
            try:
                WebDriverWait(driver, 3).until(EC.presence_of_element_located((By.CSS_SELECTOR, ".el-button--mini > span"))).click()
            except:
                pass
            WebDriverWait(driver, 3).until(EC.presence_of_element_located((By.CSS_SELECTOR, ".right-menu:nth-child(3) .user-avatar"))).click()
            time.sleep(0.5)
            pyautogui.press('down')
            pyautogui.press('enter')
            WebDriverWait(driver, 3).until(EC.presence_of_element_located((By.CSS_SELECTOR, ".el-dropdown:nth-child(1) .set"))).click()
            time.sleep(0.5)
            pyautogui.press('down', 3)
            pyautogui.press('enter')
            driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(1) .el-input__inner").send_keys("16349527")
...
class Setup_standby(object):
    ...
    def set_standby(self):
        driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(2) .el-input__inner").clear()
        #driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(2) .el-input__inner").send_keys(Keys.BACK_SPACE)
        driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(2) .el-input__inner").send_keys("233")
        driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(3) .el-input__inner").clear()
        #driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(3) .el-input__inner").send_keys(Keys.BACK_SPACE)
        driver.find_element(By.CSS_SELECTOR, ".el-form-item:nth-child(3) .el-input__inner").send_keys("232")
    ...
    def clean_standby(self):
        driver.find_element(By.CSS_SELECTOR, ".el-button--small:nth-child(2) > span").click()
        time.sleep(0.5)
        driver.find_element(By.CSS_SELECTOR, ".el-button--default:nth-child(2) > span").click()
        time.sleep(2)
        pyautogui.press('F5')
    ...
    def standby_set_run(self):
        pyautogui.alert('注意是否只有一台空白设备且连线正确')
        time.sleep(0.5)
        self.web_open_LAN2()
        try:
            self.set_standby()
    ...
    def reset_BOX(self):
        ...
        try:#try to test if BOX Login
            ...
            try:
                ...
                pass
            WebDriverWait(driver, 5, 1).until(EC.presence_of_element_located((By.CSS_SELECTOR, ".right-menu:nth-child(3) .user-avatar"))).click()
            time.sleep(0.3)
            pyautogui.press('down')
            pyautogui.press('enter')
            WebDriverWait(driver, 3).until(EC.presence_of_element_located((By.CSS_SELECTOR, ".el-dropdown:nth-child(1) .set"))).click()
